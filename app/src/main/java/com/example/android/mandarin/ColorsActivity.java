...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // words.add("yi");
        words.add(new Word("red","Hóngsè", "四",R.drawable.color_red, R.raw.color_red));
        words.add(new Word("orange","chéngzi", "四",R.drawable.color_red, R.raw.color_red));
        words.add(new Word("yellow","huángsè", "四",R.drawable.color_red, R.raw.color_red));
        words.add(new Word("four","si", "四",R.drawable.color_red, R.raw.color_red));
        words.add(new Word("five","wu", "四",R.drawable.color_red, R.raw.color_red));
        words.add(new Word("six","liu", "四",R.drawable.color_red, R.raw.color_red));
